namespace BookShop.Initializer.Generators
{
    ...
    internal class BookGenerator
    {
        ...
        private const string bookDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, " +
        ...
        internal static Book[] CreateBooks()
        {
            ...
            {
                string[] bookTokens = booksInput[i]
                    .Split();

                int edition = int.Parse(bookTokens[0]);
                DateTime releaseDate = DateTime.ParseExact(bookTokens[1], "d/M/yyyy",
